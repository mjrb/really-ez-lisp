...
return func() Argument{if(and([]Argument{RezEqual([]Argument{RezLen([]Argument{args[0]}),MkArgi(0)}),RezGreater([]Argument{RezLen([]Argument{args[1]}),MkArgi(0)})}).value!=0){return func() Argument{if(RezEqual([]Argument{RezLen([]Argument{args[1]}),MkArgi(1)}).value!=0){return head([]Argument{args[1]})};return join([]Argument{head([]Argument{args[1]}),merge([]Argument{args[0],tail([]Argument{args[1]})})})}()};return func() Argument{if(RezEqual([]Argument{RezLen([]Argument{args[1]}),MkArgi(0)}).value!=0){return func() Argument{if(RezEqual([]Argument{RezLen([]Argument{args[0]}),MkArgi(1)}).value!=0){return head([]Argument{args[0]})};return func() Argument{if(RezGreater([]Argument{RezLen([]Argument{args[0]}),MkArgi(1)}).value!=0){return join([]Argument{head([]Argument{args[0]}),merge([]Argument{tail([]Argument{args[0]}),args[1]})})};return MkArgi(0)}()}()};return func() Argument{if(RezLesser([]Argument{head([]Argument{args[0]}),head([]Argument{args[1]})}).value!=0){return join([]Argument{head([]Argument{args[0]}),merge([]Argument{tail([]Argument{args[0]}),args[1]})})};return join([]Argument{head([]Argument{args[1]}),merge([]Argument{args[0],tail([]Argument{args[1]})})})}()}()}()
}
